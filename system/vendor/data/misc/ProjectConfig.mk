...
CUSTOM_HAL_IMGSENSOR = s5k3p3sx_mipi_raw s5k3p3sx_mipi_raw_eeprom sp5506_mipi_raw gc5024_mipi_raw gc0310_mipi_yuv
CUSTOM_HAL_LENS = dw9800af dw9714af dummy_lens
CUSTOM_HAL_MAIN2_IMGSENSOR =
CUSTOM_HAL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_HAL_MAIN_BACKUP_LENS =
CUSTOM_HAL_MAIN_IMGSENSOR = s5k3p3sx_mipi_raw s5k3p3sx_mipi_raw_eeprom sp5506_mipi_raw  gc5024_mipi_raw
CUSTOM_HAL_MAIN_LENS = dw9800af dw9714af
...
CUSTOM_KERNEL_IMGSENSOR = s5k3p3sx_mipi_raw s5k3p3sx_mipi_raw_eeprom sp5506_mipi_raw gc5024_mipi_raw gc0310_mipi_yuv
CUSTOM_KERNEL_IN_POCKET_SENSOR = no
CUSTOM_KERNEL_KPD = kpd
CUSTOM_KERNEL_LEDS = mt65xx
CUSTOM_KERNEL_LENS = dw9800af dw9714af dummy_lens
CUSTOM_KERNEL_MAGNETOMETER = yes
CUSTOM_KERNEL_MAIN2_BACKUP_IMGSENSOR =
CUSTOM_KERNEL_MAIN2_IMGSENSOR =
CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_KERNEL_MAIN_BACKUP_LENS =
CUSTOM_KERNEL_MAIN_IMGSENSOR = s5k3p3sx_mipi_raw s5k3p3sx_mipi_raw_eeprom sp5506_mipi_raw  gc5024_mipi_raw
CUSTOM_KERNEL_MAIN_LENS = dw9800af dw9714af
...
CUSTOM_MODEM = t900_hct6757_66_n-lwctg_mp5-gsm4p_w1_8_fdd1_3_7_8_20_airoha
...
#CREATE_PROJECT_INFO=20170207151430
#分支信息
HCT_BUILD_PRODUCT_NAME = t900a-dg-a59-63m-hd-512g32g-bom1-3m-n-Discrete
...
#版本号.内部版本号
MTK_BUILD_VERNO = DOOGEE-MIX-Helio_P25-20170818
CUSTOM_BUILD_VERNO = R18

#型号以及品牌
HCT_PRODUCT_BRAND = DOOGEE
HCT_PRODUCT_MODEL = MIX
...
#HCT文件管理
#HCT_FILEEXPLORER_SUPPORT = yes
HCT_DIALPAD_STYLE = yes
#扫码
HCT_QR_CODE_SCAN = yes
#HCT_SUPPORT_QUICK_FLASHLIGHT = yes
...
HCT_SUPPORT_MINISCREEN = yes
HCT_SUPPORT_MODIRY_PHONEINFO_FOR_DOOGEE = yes
#港云相机
GANGYUN_CAMERA_BEAUTY=yes
GANGYUN_CAMERA_BEAUTYSNAP=yes
GANGYUN_BOKEH_SUPPORT=yes
ARCSOFT_CAMERA_BEAUTY=yes
#GYCamera
HCT_GYCAMERA_SUPPORT = yes
#悬浮窗
#HCT_FLOATVIEW = yes
#HCT_FLOATVIEW2 = yes
#fingerprint指纹迈瑞微
HCT_SUPPORT_FINGERPRINT = yes
#HCT_SUPPORT_FINGERPRINT_CHIP = microarray sunwave
HCT_SUPPORT_FINGERPRINT_CHIP = microarray_83t_tee
#HCT_SUPPORT_FINGERPRINT_CHIP = microarray_80t
HCT_WHITE_LIST = yes
#广升FOTA
...
HCT_GOOGLE_CLIENTIDBASE_AM = android-doogee
#HCT_GOOGLE_CLIENTIDBASE_YT = android-doogee
HCT_GOOGLE_CLIENTIDBASE_MS = android-doogee
#HCT_GOOGLE_CLIENTIDBASE_GMM = android-doogee
HCT_MODIFY_FOR_CTS=yes
HCT_GOOGLE_GMS_R9 = yes
HCT_SUPPORT_MODIRY_PHONEINFO_FOR_DOOGEE=yes
HCT_PACKAGES_SUBSTITUTE = Books:- CalendarGoogle:- CloudPrint:- DeskClockGoogle:- EditorsDocs:- EditorsSheets:-  EditorsSlides:- FaceLock:-  GoogleCamera:- GoogleEars:- GoogleEarth:- GoogleHindiIME:- GoogleHome:- GooglePinyinIME:- Keep:- KoreanIME:-  LatinImeGoogle:- Newsstand:- NewsWeather:- PlayGames:- Street:- TagGoogle:- Wallet:- DMAgent:-  AndroidPay:- Bugle:- QuickSearchBox:-  MtkQuickSearchBox:- CalculatorGoogle:- ExactCalculator:- Home:- Launcher2:- Launcher3:- HctLauncher3Mu:- JapaneseIME:-
